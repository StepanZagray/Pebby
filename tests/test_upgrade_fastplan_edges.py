...
from tools import upgrade_fastplan_edges as m
...
'''
PY_NEW=PY_OLD
C_OLD=(Path(__file__).parent/'fixtures/fastplan_source_edges_before.c').read_text()
C_NEW=m.compress_source_edges(C_OLD)

class EdgeStorageMigrationTests(unittest.TestCase):
