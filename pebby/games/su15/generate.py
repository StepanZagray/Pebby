...
FULL_STANDARD_CONTRACT = {
    ...
    "evidence": {
        ...
        "independent_closure": ".scratch/multigame-resume/full-standard/external-astra-su15/su15-closure-detailed.md",
        "final_sequence_closure": ".scratch/multigame-resume/full-standard/external-su15-sequence-fix/su15-detailed.md and root focused rerun: 2 passed in 8.92s",
