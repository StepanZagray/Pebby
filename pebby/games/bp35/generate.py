...
FULL_STANDARD_CONTRACT = {
    ...
    "evidence": {
        "official_tier_characterization": ".scratch/multigame-resume/full-standard/bp35.md#native-reference-inventory",
        "solution_mechanics": ".scratch/multigame-resume/full-standard/bp35.md#generated-curriculum-and-modes",
        "native_budget": ".scratch/multigame-resume/full-standard/bp35.md#native-reference-inventory",
        "context_engine_replay": ".scratch/multigame-resume/full-standard/bp35-final.md",
        "novelty_split": ".scratch/multigame-resume/full-standard/bp35.md#bounded-correction-evidence",
        "bounded_rejections": ".scratch/multigame-resume/full-standard/bp35.md#bounded-correction-evidence",
        "structural_chamber_replay": ".scratch/multigame-resume/full-standard/native-astra-bp35-chambers/review.md#independent-native-execution",
        "root_train_replay": ".scratch/multigame-resume/full-standard/bp35-chambers-root-train.json",
        "root_validation_replay": ".scratch/multigame-resume/full-standard/bp35-chambers-root-validation.json",
        "root_test_replay": ".scratch/multigame-resume/full-standard/bp35-chambers-root-test.json",
        "native_frame_review": ".scratch/multigame-resume/full-standard/bp35-render-comparison.json",
        "official_copy_deny": ".scratch/multigame-resume/full-standard/bp35.md#bounded-correction-evidence",
    },
    "caveats": [
